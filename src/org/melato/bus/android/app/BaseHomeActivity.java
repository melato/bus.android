 ...
 *  */
public abstract class BaseHomeActivity extends Activity implements OnItemClickListener {
  ...
  void initMenus() {
    for( LaunchItem item: getInternalLaunchItems() ) {
      items.add(item);
    }
    MenuStorage db = getMenuStorage();
    if ( db != null) {
